...
const Answer = await inquirer.prompt([
  ...
  },
  {
    message: chalk.black.yellow.underline.italic(
      "*Select one of the operator to perform operation*"
    ),
    type: "list",
    name: "operator",
    choices:[
...
if (Answer.operator == "Addition") {
  console.log(
    chalk.whiteBright.bgRed("Your value is"),
    Answer.FirstNumber + Answer.SecondNumber
  );
} else if (Answer.operator == "Subtraction") {
  console.log(
    chalk.redBright.bgBlue("Your value is"),
    Answer.FirstNumber - Answer.SecondNumber
  );
} else if (Answer.operator == "Multiplication") {
  console.log(
    chalk.black.bgYellow("Your value is"),
    Answer.FirstNumber * Answer.SecondNumber
  );
} else if (Answer.operator == "Exponentiation") {
  console.log(
    chalk.black.bgGreen("Your value is"),
    Answer.FirstNumber ** Answer.SecondNumber
  );
} else if (Answer.operator == "Division") {
  console.log(
    chalk.gray.bgWhite("Your value is"),
    Answer.FirstNumber / Answer.SecondNumber
  );
} else if (Answer.operator == "Modulus") {
  console.log(
    chalk.blue.bgYellow("Your value is"),
    Answer.FirstNumber % Answer.SecondNumber
  );
} else {
